...
GITLOCAL="events-calendar-pro-alarm"
...
SVNURL="http://plugins.svn.wordpress.org/the-events-calendar-pro-alarm/" # Remote SVN repo on wordpress.org, with no trailing slash
